...
public class DockNode extends VBox implements EventHandler<MouseEvent> {
	...
	/**
	 * Initialize a default DockNode (KMY Original Method)
	 */
	...
	/**
	 * Creates a default DockNode for FXML (KMY Original method)
	 */
	public DockNode() {
	}
	...
	public void setDockPos(DockPos pos) {
		this.dockPos = pos;
		if (this.dockPane != null) {
			this.dock(this.dockPane, pos);
		}
	}
